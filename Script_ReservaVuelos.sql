...
insert into vueloGenerico (nVuelo, horaSalida, horaLlegada, aeropuerto_origen, aeropuerto_destino, precio, capacidad, ordenAsiento, aeropuerto_id, aerolinea_id) values (1, 10, 11, "Tenerife Norte", "Lanzarote", 100, 50, 1, 1);
insert into vueloGenerico (nVuelo, horaSalida, horaLlegada, aeropuerto_origen, aeropuerto_destino, precio, capacidad, ordenAsiento, aeropuerto_id, aerolinea_id) values (2, 10, 11, "Tenerife Sur", "La Palma", 100, 50, 2, 2);
